...
export const FEATURED_STYLE = `bg-p3 hover:scale-105 hover:bg-red-800 ${allStyles}`;
export const FEATURED_TEXT_STYLE =`animate-bounce text-lightyellows  ${h1featureStyle}`
