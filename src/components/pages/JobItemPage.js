...
const JobItemPage = job => {
    ...
    const getContentTest = () => {
        return (
            <div className="bg-gray-50 overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
                    <div className="text-base max-w-prose mx-auto lg:max-w-none text-white">
                        <h2 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">Work with us</h2>
    ...
    return (
        PageContainer(getContentTest(), { isShown: false })
    )
};
